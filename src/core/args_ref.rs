...
const BOOL_ARG_KEYS: [&str; 27] = ["after", "all", "allowEmpty", "allowMissing", "amend", "check", "force", "ignoreCase", "includeFiles", "includeHidden", "includeUntracked", "initializeIfNotPresent", "isUrl", "literal", "literalSearch", "nameOnly", "noDefaultExcludes", "noVerify", "overwrite", "quiet", "recursive", "resetAuthor", "staged", "stat", "stealth", "update", "validateGitRepo"];
