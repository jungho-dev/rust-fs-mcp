...
fn is_public_ip(ip: &IpAddr) -> bool {
  match ip {
    IpAddr::V4(v4) => {
      ...
      !(v4.is_loopback() || v4.is_private() || v4.is_link_local() || v4.is_broadcast() || v4.is_documentation() || v4.is_unspecified() || is_shared || is_this_network || is_multicast_or_reserved)
    }
    IpAddr::V6(v6) => {
