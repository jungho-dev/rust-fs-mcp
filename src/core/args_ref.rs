...
const BOOL_ARG_KEYS: [&str; 23] = ["after", "all", "allowEmpty", "allowMissing", "amend", "force", "ignoreCase", "includeFiles", "includeHidden", "includeUntracked", "initializeIfNotPresent", "isUrl", "literal", "literalSearch", "nameOnly", "noDefaultExcludes", "noVerify", "recursive", "resetAuthor", "staged", "stat", "update", "validateGitRepo"];
...
const NUM_ARG_KEYS: [&str; 31] = ["args_length", "args_offset", "content_length", "content_offset", "contextLines", "depth", "end_line", "expected_lines", "expected_replacements", "length", "line_count", "maxEntries", "maxMatches", "maxResults", "maxSnippetChars", "maxSnippets", "messageLength", "messageOffset", "new_string_length", "new_string_offset", "offset", "old_string_length", "old_string_offset", "pattern_length", "pattern_offset", "replacement_length", "replacement_offset", "start_line", "timeout_ms", "value_length", "value_offset"];
